...
<div class="card">
    ...
    <form action="{{ route('admin.gifts.update', $gift) }}" method="POST">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="type" id="type" value="{{ old('type', $gift->type) }}" required
                style="width: 100%; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px;"
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="number" name="value" id="value" value="{{ old('value', $gift->value) }}" step="0.01" min="0"
                style="width: 100%; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px;"
        ...
        <div style="margin-bottom: 20px;">
            ...
            <textarea name="description" id="description" rows="4"
                style="width: 100%; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px;"
                placeholder="Enter gift description...">{{ old('description', $gift->description) }}</textarea>
        </div>
