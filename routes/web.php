...
Route::get('/qr/{code}/already-scanned', [QRScanController::class, 'alreadyScanned'])->name('qr.already-scanned');
...
Route::get('/qr/{code}/thanks', [QRScanController::class, 'thanks'])->name('qr.thanks');
